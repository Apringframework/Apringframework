...
public final class AndroidApplicationContext extends DefaultApplicationContext implements Serializable {
    ...
    public void initialize(BeanFactoryFetcher factoryFetcher) {
        ...
        try {
            ...
            throw new IllegalStateException(
                    "Cannot initialize classes annotated with @Component! These classes will not work properly.");
        }
    }
    ...
    private Object initialize(Class<?> cls, Object... params) {
        try {
            ...
            throw new IllegalStateException(
                    "Cannot find a declared constructor with parameter types : "
                            + StringUtils.joinToString(
                                    params, (o) -> o.getClass().getName(), ","),
                    e.getCause());
        } catch (InvocationTargetException | IllegalAccessException | InstantiationException e) {
            throw new IllegalStateException(
                    "Cannot create new instance with parameter types : "
                            + StringUtils.joinToString(
                                    params, (o) -> o.getClass().getName(), ","),
                    e.getCause());
        }
