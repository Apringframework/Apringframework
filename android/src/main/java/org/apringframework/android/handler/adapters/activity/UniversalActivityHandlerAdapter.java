...
public final class UniversalActivityHandlerAdapter implements HandlerAdapter {
    /***
    ...
    public boolean support(Handler handler) {
        return handler instanceof UniversalActivityHandler;
    }
    ...
    public ModelOrView handle(Context context, Object action, Handler handler) {
        ...
        if (action instanceof ActivityRequestAction) {
            ...
            AndroidManager.startActivity(contextActivity, intent);
        }
