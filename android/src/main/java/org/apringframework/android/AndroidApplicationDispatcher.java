...
public final class AndroidApplicationDispatcher implements ApplicationDispatcher {
    ...
    private void initializeHandlerMappings(Context context) {
        if (handlerMappings == null) handlerMappings = new ArrayList<>();
    ...
    private void initializeHandlerAdapters(Context context) {
        if (handlerAdapters == null) handlerAdapters = new ArrayList<>();
    ...
    public HandlerAdapter getHandlerAdapter(Handler handler) {
        for (HandlerAdapter handlerAdapter : handlerAdapters) {
            if (handlerAdapter.support(handler)) return handlerAdapter;
        }
        return null;
    }
    /***
    ...
    public void dispatch(Context context, Object action) {
        ...
        if (adapter == null) throw new IllegalStateException("Cannot find suitable handler adapter for " + action);
